...
class $FilesTable extends Files with TableInfo<$FilesTable, FileRow> {
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('server_file_id')) {
      ...
      context.missing(_serverFileIdMeta);
    }
...
final class $$ConversationsTableReferences
  ...
  static MultiTypedResultKey<$FilesTable, List<FileRow>> _filesRefsTable(
    _$AppDatabase db,
  ) => MultiTypedResultKey.fromTable(
    db.files,
    aliasName: 'conversations__id__files__conversation_id',
  );
...
class $$ConversationsTableTableManager
    extends
        RootTableManager<
          ...
          ConversationRow,
          PrefetchHooks Function({bool messagesRefs, bool filesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({messagesRefs = false, filesRefs = false}) {
...
final class $$FilesTableReferences
    extends BaseReferences<_$AppDatabase, $FilesTable, FileRow> {
  ...
  static $ConversationsTable _conversationIdTable(_$AppDatabase db) =>
      db.conversations.createAlias('files__conversation_id__conversations__id');
