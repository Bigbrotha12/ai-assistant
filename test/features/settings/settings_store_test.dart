...
void main() {
  ...
  test('save scrubs legacy LLM override keys from earlier builds', () async {
    final storage = InMemorySecureStorage();
    final store = SecureSettingsStore(storage: storage);
    storage._values['backend_llm_base_url'] = 'https://chat.example';
    storage._values['backend_llm_model'] = 'agent_old';
    storage._values['backend_llm_api_key'] = 'sk-old';
